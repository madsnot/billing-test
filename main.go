...
func ReserveWriteOff(context *gin.Context) {
...
func main() {
	...
	router.POST("/balance/topUp", ValidOpenDataBase(TopUpUserBalance))
	router.GET("/balance/:userId", ValidOpenDataBase(GetUserBalance))
	router.POST("/payment/reserve", ValidOpenDataBase(ReserveAmountForPayment))
	router.POST("/payment", ReserveWriteOff)
